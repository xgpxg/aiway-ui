<template>
  <div>
    ...
    <el-table class="table draggable" :data="value" row-key="id"
      ...
      <el-table-column label="数据类型" prop="dataType" width="140">
        <template #default="{row}">
      ...
      <el-table-column label="必须" prop="required" width="100">
        <template #default="{row}">
          <el-switch v-model="row.required" :active-value="1" :inactive-value="0"></el-switch>
